...
const HeroCarousel = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            <div className="animate-fade-in">
              <p className="text-gold text-lg font-medium mb-4 tracking-wider uppercase">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="flex items-center space-x-2 px-8 py-4 border-2 border-gold text-gold hover:bg-gold hover:text-onyx transition-all duration-300 rounded-full">
                  <Play size={16} />
                  <span>{slides[currentSlide].cta2}</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <button
        onClick={prevSlide}
        className="absolute left-8 top-1/2 transform -translate-y-1/2 z-30 p-3 rounded-full bg-black bg-opacity-50 text-white hover:bg-opacity-70 transition-all duration-200"
      >
        <ChevronLeft size={24} />
      </button>
      ...
      <button
        onClick={nextSlide}
        className="absolute right-8 top-1/2 transform -translate-y-1/2 z-30 p-3 rounded-full bg-black bg-opacity-50 text-white hover:bg-opacity-70 transition-all duration-200"
      >
